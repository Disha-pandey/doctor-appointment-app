...
const TopDoctors = () => {
  ...
  if (!Array.isArray(doctors)) {
    return <div className="text-center py-6">Loading top doctors...</div>;
  }
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <button
        ...
        className="mt-6 px-6 py-2 bg-blue-200 text-white rounded-full hover:bg-blue-600 transition"
      >
        More
      </button>
    </div>
